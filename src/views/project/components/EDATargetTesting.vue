...
<template>
    ...
    <div style="width: 100%; display: grid; grid-template-columns: repeat(2, 1fr); gap: 1rem">
        ...
        <EDATargetValueList
            ...
            configDescription="Input files are sent from the workspace folder to the IVerilog worker."
        />
        ...
        <EDATargetValueList
            ...
            configNameOnePerLine
            configDescription="Output files are sent from the workspace folder to the IVerilog worker."
        />
    </div>
</template>
