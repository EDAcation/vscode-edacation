...
<template>
    <div style="width: 100%">
        ...
        <div style="width: 100%; display: grid; gap: 1rem">
            ...
            <!--
            we refer to synthGeneratedOptions here, but internally the input/output files
            are generated in the same way for the RTL & synth tasks, so it doesn't matter
            -->
            <EDATargetValueList
                :targetIndex="targetIndex"
            ...
            >
                Input files for the RTL and synthesis generation steps.
                <br /><br />
            ...
            <EDATargetValueList
                ...
                configNameOnePerLine
            >
                Output files for the RTL and synthesis generation steps.
                <br /><br />
